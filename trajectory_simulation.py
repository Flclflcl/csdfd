    ...
    for i in range(trajectory_length):
        ...
        if i == 0:
            ...
            if np.sum(obs_collision_ind) > 0:
                x_check = x_hist_inv[i][:, obs_collision_ind]  # The position of the demo where the collision occurred
                obs_index = obs_check(x_check, x_obs_, r)      # Obtain the sequence number of the obstacle corresponding to the collision demo location
